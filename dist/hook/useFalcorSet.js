...
exports.UseFalcorSet = function (model, _a) {
    ...
    return function (pathValue) {
        ...
        var handler = __1.useStreamCallback(function (stream$) { return stream$.pipe(operators_1.switchMap(function (data) {
            return rxjs_1.from(model.set.apply(model, pathValue(data))).pipe(operators_1.map(function (_a) {
                var json = _a.json;
